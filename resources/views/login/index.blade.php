        ...
        <div class="row">
            ...
            <div class="col-4 offset-4">
                <div class="my-3">
                    ...
                    <input type="text" class="form-control col-8" aria-describedby="name" value="{{ old('name') }}" required>
                </div>
                <div class="my-3">
                    <label class="form-label" id="password">パスワード</label>
                    <input type="password" class="form-control col-8" aria-describedby="password" value="" required>
                </div>
            </div>
