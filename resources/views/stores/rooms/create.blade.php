    ...
    <form class="room-content-wrapper" action="{{route('stores.rooms.store', $store_id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="img-select-wrapper row mx-2">
            <div class="col-4 mr-1">
                ...
                <img src="{{ asset('storage/images/no-img.png') }}" alt="room-pic1" class="room-pic" id="file-preview1">
            </div>
            <div class="col-4 mr-1">
                ...
                <img src="{{ asset('storage/images/no-img.png') }}" alt="room-pic2" class="room-pic" id="file-preview2">
            </div>
            <div class="col-4 ">
                ...
                <img src="{{ asset('storage/images/no-img.png') }}" alt="room-pic3" class="room-pic" id="file-preview3">
            </div>
        </div>
