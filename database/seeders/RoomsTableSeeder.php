    ...
    public function run()
    {
        ...
        for ($i=0; $i < 2; $i++) {
            ...
            for ($x=0; $x < count($room_type_title); $x++) {
                for ($y=0; $y < 5; $y++) {
                    $room_number_title = $x+$y+((5-1)*$x)+101;
        ...
        $amenities_washitsu1 = [
            'icon' => ['布団', '無料wifi', 'ナイトウェア、パジャマ', 'バスタオル、フェイスタオル', 'シャンプー', 'コンディショナー', 'ボディーソープ', '歯ブラシ', 'くし'],
            'amenity_name' => ['fas fa-bed', 'fas fa-wifi', 'fas fa-tshirt', 'images/icons/towel.png', 'fas fa-pump-soap', 'fas fa-pump-soap', 'fas fa-pump-soap', 'images/icons/toothbrush.png', 'images/icons/comb.png']
        ];

        $amenities_washitsu2 = [
            'icon' => ['ダブルベッド', '無料wifi', 'ナイトウェア、パジャマ', 'バスタオル、フェイスタオル', 'シャンプー', 'コンディショナー', 'ボディーソープ', '歯ブラシ', 'くし'],
            'amenity_name' => ['fas fa-bed', 'fas fa-wifi', 'fas fa-tshirt', 'images/icons/towel.png', 'fas fa-pump-soap', 'fas fa-pump-soap', 'fas fa-pump-soap', 'images/icons/toothbrush.png', 'images/icons/comb.png']
        ];

        $amenities_youshitsu1 = [
            'icon' => ['ツインベッド', '無料wifi', 'ナイトウェア、パジャマ', 'バスタオル、フェイスタオル', 'シャンプー', 'コンディショナー', 'ボディーソープ', '歯ブラシ', 'くし'],
            'amenity_name' => ['fas fa-bed', 'fas fa-wifi', 'fas fa-tshirt', 'images/icons/towel.png', 'fas fa-pump-soap', 'fas fa-pump-soap', 'fas fa-pump-soap', 'images/icons/toothbrush.png', 'images/icons/comb.png']
        ];

        $amenities_youshitsu2 = [
            'icon' => ['シングルベッド', '無料wifi', 'ナイトウェア、パジャマ', 'バスタオル、フェイスタオル', 'シャンプー', 'コンディショナー', 'ボディーソープ', '歯ブラシ', 'くし'],
            'amenity_name' => ['fas fa-bed', 'fas fa-wifi', 'fas fa-tshirt', 'images/icons/towel.png', 'fas fa-pump-soap', 'fas fa-pump-soap', 'fas fa-pump-soap', 'images/icons/toothbrush.png', 'images/icons/comb.png']
        ];
